...
export async function generateMetadata(): Promise<Metadata> {
  const { courses } = await getKildareCountyCourses();
  const courseCount = courses.length;

  const title = `${courseCount} Golf Courses in County Kildare | Access & Prices`;

  const description = `Explore ${courseCount} visitor-friendly golf courses in County Kildare, Ireland, including The K Club, Carton House and Moyvalley. Compare visitor access and prices.`;
  ...
  return {
    ...
    alternates: {
      canonical: "/golf-courses-kildare",
    },

    openGraph: {
      title,
      description,
      url: `${siteUrl}/golf-courses-kildare`,
  ...
  return (
    <>
      <h2 className="text-lg font-semibold text-slate-900">
        Continue planning your Kildare golf trip
      </h2>

      <p className="mt-3 text-sm leading-6 text-slate-600">
        Explore more golf around Dublin and across Ireland, or put your Kildare
...
export default async function GolfCoursesKildarePage() {
  const { courses, error } = await getKildareCountyCourses();
        ...
        <div className="mx-auto max-w-[480px] lg:max-w-[1120px]">
          ...
          <div className="mt-6 lg:max-w-[800px]">
            ...
            <p className="mt-4 text-[15px] leading-6 text-emerald-50/95 lg:max-w-[740px] lg:text-[17px] lg:leading-7">
              ...
              County Kildare, Ireland, with visitor access, prices and
            ...
            <p className="mt-3 text-[15px] leading-6 text-emerald-50/95 lg:max-w-[740px] lg:text-[17px] lg:leading-7">
              From The K Club and Carton House to Moyvalley, pick your rounds
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              <span className="inline-block rounded-full bg-white/15 px-4 py-2 text-sm font-semibold text-white backdrop-blur">
                {courseCount} courses in County Kildare
              </span>
              ...
              {courseTypes.length > 0 && (
                <span className="hidden rounded-full bg-white/10 px-4 py-2 text-sm font-semibold text-white/90 backdrop-blur sm:inline-block">
                  Parkland & inland links-style golf
                </span>
              )}
            </div>
          </div>
        ...
        <div className="grid min-w-0 gap-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-stretch">
          <section className="min-w-0 rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200/70 lg:flex lg:h-full lg:flex-col lg:p-7">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-600">
              County Kildare, the Thoroughbred County, makes a great base for
              golf within easy reach of Dublin. The K Club&apos;s Palmer North
              runs through parkland and hosted the 2006 Ryder Cup. Palmer
              South has a more open, links-style feel, with mounding and rock
              features around the course.
            </p>

            <p className="mt-4 text-sm leading-7 text-slate-600">
              Carton House offers two quite different rounds. The O&apos;Meara
              winds through woodland beside the River Rye, while the
              Montgomerie brings an inland links-style challenge with deep
              bunkers. Further west, Moyvalley&apos;s Darren Clarke design has
              plenty of holes where it pays to think your way around.
            </p>

            <p className="mt-4 text-sm leading-7 text-slate-600">
              There&apos;s more to Kildare than golf. You could catch a race
              meeting at the Curragh, visit the Irish National Stud and
              Japanese Gardens, or spend an afternoon in Kildare town.
            </p>

            <p className="mt-4 text-sm leading-7 text-slate-600">
              GuestPlayGolf lists {courseCount} courses in Kildare. Compare
              visitor access, prices and course types below, then add your
              preferred rounds to your trip.
            </p>
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl bg-stone-50 p-4 ring-1 ring-slate-200">
                ...
                <p className="mt-1 text-xs leading-5 text-slate-500">
                  Every listed visitor-friendly course located in County Kildare.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-stone-50 p-4 ring-1 ring-slate-200">
                ...
                <p className="mt-1 text-xs leading-5 text-slate-500">
                  See when independent guests can play each Kildare course.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-stone-50 p-4 ring-1 ring-slate-200">
                ...
                <p className="mt-1 text-xs leading-5 text-slate-500">
                  Use price bands to compare Kildare courses before planning.
                </p>
              </div>
            </div>
          </section>
          ...
          <aside className="min-w-0">
            <div className="flex h-full flex-col rounded-3xl bg-emerald-50 p-5 shadow-sm ring-1 ring-emerald-100 lg:p-6">
              ...
              <h2 className="mt-4 text-xl font-bold text-slate-900">
                Build your Kildare golf trip
              </h2>

              <p className="mt-3 text-sm leading-6 text-slate-700">
                Choose Kildare courses, build a day-by-day itinerary and organise
              ...
              <div className="mt-4 grid gap-3">
                <div className="flex gap-3">
                  ...
                  <p className="pt-1 text-sm text-slate-700">
                    Compare the Kildare courses below.
                  </p>
                </div>
              ...
              <div className="mt-auto pt-5">
                ...
                <p className="mt-3 text-center text-xs leading-5 text-slate-600">
                  Browse Kildare courses below and add your preferred options as
                  you go.
                </p>
              </div>
            </div>
        ...
        <section className="mt-6">
          <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-1 text-xl font-bold text-slate-900 lg:text-2xl">
                {courseCount} golf courses in County Kildare
              </h2>
            </div>
          ...
          {error && (
            <div className="mb-6 rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
              Error loading golf courses in Kildare.
            </div>
          )}
