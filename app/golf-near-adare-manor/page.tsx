        ...
        <div className="mx-auto max-w-[480px] lg:max-w-[1120px]">
          ...
          <div className="mt-6 lg:max-w-[780px]">
            ...
            <h1 className="mt-2 text-[28px] font-bold leading-tight sm:text-[32px] lg:text-[42px] lg:leading-[1.08]">
              Golf Near Adare Manor: Find Courses and Plan Your Trip
            </h1>
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              ...
              <span className="hidden rounded-full bg-white/10 px-4 py-2 text-sm font-semibold text-white/90 backdrop-blur sm:inline-block">
                Ryder Cup region, links and parkland golf
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="grid min-w-0 gap-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-stretch">
          <section className="min-w-0 rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200/70 lg:flex lg:h-full lg:flex-col lg:p-7">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-600">
              Adare Manor is one of Ireland&apos;s most important golf
              destinations, with global attention from the Ryder Cup and a
              location that works well for a west of Ireland golf trip. An 80 km
              radius keeps the focus on realistic golf options from Adare while
              still covering major courses across Limerick, Clare and Kerry.
            </p>

            <p className="mt-4 text-sm leading-7 text-slate-600">
              Golf near Adare Manor offers a strong mix of course styles. The
              region includes premium resort and parkland golf, accessible inland
              clubs and some of Ireland&apos;s most famous Atlantic links within
              driving range. This makes Adare a useful base for golfers who want
              more than one type of course on the same trip.
            </p>

            <p className="mt-4 text-sm leading-7 text-slate-600">
              Limerick access, Shannon Airport and routes towards Clare and
              Kerry make the area practical for visiting golfers. Many trips can
              combine Adare Manor interest with courses such as Ballybunion,
              Lahinch, Doonbeg and other strong visitor options in the wider
              region.
            </p>
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl bg-stone-50 p-4 ring-1 ring-slate-200">
                ...
                <p className="mt-1 text-xs leading-5 text-slate-500">
                  A major golf destination built around Adare Manor and nearby
                  Limerick.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-stone-50 p-4 ring-1 ring-slate-200">
                ...
                <p className="mt-1 text-xs leading-5 text-slate-500">
                  Access towards famous Atlantic links in Clare and Kerry.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-stone-50 p-4 ring-1 ring-slate-200">
                ...
                <p className="mt-1 text-xs leading-5 text-slate-500">
                  Resort, estate and inland courses within practical driving
                  range.
                </p>
              </div>
            </div>
          ...
          <aside className="min-w-0">
            <div className="flex h-full flex-col rounded-3xl bg-emerald-50 p-5 shadow-sm ring-1 ring-emerald-100 lg:p-6">
              ...
              <h2 className="mt-4 text-xl font-bold text-slate-900">
                Build your Adare Manor golf trip
              </h2>

              <p className="mt-3 text-sm leading-6 text-slate-700">
                Choose courses, build a day-by-day itinerary and organise your
                Adare Manor golf trip in one place. Share the plan and let your
