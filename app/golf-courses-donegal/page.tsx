...
const getDonegalCourses = cache(async () => {
...
export async function generateMetadata(): Promise<Metadata> {
  const { courses } = await getDonegalCourses();
  const courseCount = courses.length;

  const title = `${courseCount} Golf Courses in Donegal | Access & Prices`;

  const description = `Explore ${courseCount} visitor-friendly golf courses in County Donegal, Ireland. Compare visitor access, prices and course types, then build and share a free Donegal golf trip itinerary.`;
  ...
  return {
    ...
    alternates: {
      canonical: "/golf-courses-donegal",
    },

    openGraph: {
      title,
      description,
      url: `${siteUrl}/golf-courses-donegal`,
  ...
  return (
    <>
      ...
      <p className="mt-3 text-sm leading-6 text-slate-600">
        Explore Ireland&apos;s links golf, compare other regional golf hubs or
        build your full trip with GuestPlayGolf.
      </p>
...
export default async function GolfCoursesDonegalPage() {
  const { courses, error } = await getDonegalCourses();
  const courseCount = courses.length;
        ...
        <div className="mx-auto max-w-[480px] lg:max-w-[1120px]">
          ...
          <div className="mt-6 lg:max-w-[800px]">
            ...
            <h1 className="mt-2 text-[28px] font-bold leading-tight sm:text-[32px] lg:text-[42px] lg:leading-[1.08]">
              Golf Courses in Donegal, Ireland
            </h1>
            ...
            <p className="mt-4 text-[15px] leading-6 text-emerald-50/95 lg:max-w-[740px] lg:text-[17px] lg:leading-7">
              ...
              County Donegal, with clear visitor access, pricing and course
              information.
            </p>

            <p className="mt-3 text-[15px] leading-6 text-emerald-50/95 lg:max-w-[740px] lg:text-[17px] lg:leading-7">
              Compare courses around the county, build your shortlist and turn
              it into a free Donegal golf-trip itinerary.
            </p>
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              <span className="inline-block rounded-full bg-white/15 px-4 py-2 text-sm font-semibold text-white backdrop-blur">
                {courseCount} courses in County Donegal
              </span>
        ...
        <div className="grid min-w-0 gap-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-stretch">
          <section className="min-w-0 rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200/70 lg:flex lg:h-full lg:flex-col lg:p-7">
            <p className="text-[12px] font-semibold uppercase tracking-[0.18em] text-emerald-800">
              County Donegal golf guide
            </p>

            <h2 className="mt-1 text-[21px] font-semibold text-slate-900 lg:text-[24px]">
              Golf in Donegal — made for the road trip
            </h2>

            <p className="mt-4 text-sm leading-7 text-slate-600">
              Donegal feels made for a golf road trip. The county stretches
              along Ireland&apos;s wild northwest coast, with mountains,
              beaches, small towns and spectacular Atlantic scenery around
              almost every corner. It is a place where getting from one course
              to the next is part of the trip rather than just the journey.
            </p>

            <p className="mt-4 text-sm leading-7 text-slate-600">
              Away from the golf, there is plenty of Donegal to explore.
              Coastal drives, traditional pubs, fishing villages and long
              stretches of the Wild Atlantic Way give you plenty of reasons not
              to rush between rounds. Base yourself in one part of the county
              or move around and make a few days of it.
            </p>

            <p className="mt-4 text-sm leading-7 text-slate-600">
              Donegal boasts {courseCount} visitor-friendly golf courses on
              GuestPlayGolf, including one of the strongest concentrations of
              links golf anywhere in Ireland. Compare where you can play, what
              it costs and the style of course, then build your favourites into
              a Donegal golf trip.
            </p>
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl bg-stone-50 p-4 ring-1 ring-slate-200">
                ...
                <p className="mt-1 text-xs leading-5 text-slate-500">
                  Visitor-friendly courses across County Donegal.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-stone-50 p-4 ring-1 ring-slate-200">
                ...
                <p className="mt-1 text-xs leading-5 text-slate-500">
                  A remarkable concentration of coastal and links golf.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-stone-50 p-4 ring-1 ring-slate-200">
                ...
                <p className="mt-1 text-xs leading-5 text-slate-500">
                  Compare access and prices before shaping your Donegal trip.
                </p>
              </div>
            </div>
          </section>
          ...
          <aside className="min-w-0">
            <div className="flex h-full flex-col rounded-3xl bg-emerald-50 p-5 shadow-sm ring-1 ring-emerald-100 lg:p-6">
              ...
              <h2 className="mt-4 text-xl font-bold text-slate-900">
                Build your Donegal golf trip
              </h2>

              <p className="mt-3 text-sm leading-6 text-slate-700">
                Choose Donegal courses, build a day-by-day itinerary and
              ...
              <div className="mt-4 grid gap-3">
                <div className="flex gap-3">
                  ...
                  <p className="pt-1 text-sm text-slate-700">
                    Compare the Donegal courses below.
                  </p>
                </div>
              ...
              <div className="mt-auto pt-5">
                ...
                <p className="mt-3 text-center text-xs leading-5 text-slate-600">
                  Browse Donegal courses below and add your preferred options
                  as you go.
                </p>
              </div>
            </div>
        ...
        <section className="mt-6">
          <div className="mb-4">
            ...
            <h2 className="mt-1 text-xl font-bold text-slate-900 lg:text-2xl">
              {courseCount} golf courses in Donegal
            </h2>
          </div>

          {error && (
            <div className="mb-6 rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
              Error loading golf courses in Donegal.
            </div>
          )}

          {courses.length === 0 ? (
            <div className="rounded-2xl bg-white p-5 text-sm text-slate-600 shadow-sm ring-1 ring-slate-200/70">
              No golf courses are currently listed in County Donegal.
            </div>
          ) : (
