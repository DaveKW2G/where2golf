          ...
          <div className="space-y-4">
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-3 text-[14px] leading-7 text-emerald-50/95">
                  {insightText}
                </p>
              </div>
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {nearbyRegions[regionCode].map((code) => (
                <Link
                  ...
                  className="rounded-full border border-slate-300 bg-slate-50 px-3 py-1.5 text-sm font-medium text-slate-700 no-underline transition hover:border-slate-400 hover:bg-slate-100"
                >
                  {code === "ZH"
                    ? "Golf near Zurich"
